...
#define MIN_PASO_RETARDO_MS 2                // Mínimo absoluto para la pausa interna.
// ------------------------------------------
...
#define RETARDO_MIN_DIFICIL_MS 600           // Retardo mínimo absoluto (velocidad máxima del juego)
