...
/**Establecer segmentos: Env?a datos crudos de segmentos al display.**/
...
/**Mostrar n?mero decimal: Convierte un n?mero entero a formato de display.**/
...
/**Codear digito: Convierte un valor num?rico (0-15) en el patr?n de bits correspondiente para encender los segmentos correctos del display de 7 segmentos**/
